...
angular.module('makemybooking.config', []).constant('config', { 'defaultApiEndpoint': '/api' }).constant('appName', 'makemybooking-client').constant('appVersion', '0.0.2').constant('appDescription', 'MakeMyBooking.co');
;
'use strict';

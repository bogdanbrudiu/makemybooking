angular.module('makemybooking.contacts', ['googleApi']).config([
  ...
  'googlePlus',
  'googleContacts',
  function ($scope, googleLogin, googleCalendar, googlePlus, googleContacts) {
...
angular.module('makemybooking.config', []).constant('config', { 'defaultApiEndpoint': 'http://www.makemybooking.co/api' }).constant('appName', 'makemybooking-client').constant('appVersion', '0.0.2').constant('appDescription', 'MakeMyBooking.co');
;
'use strict';
...
(function (module) {
  ...
  module.run([
    '$templateCache',
    function ($templateCache) {
      $templateCache.put('appointments/appointmentsView.html', '<div class="row"><div class="col-md-6"><h2>{{ \'appointment.CreateNew\' | translate }}</h2><form role="form" name="form"><div class="form-group"><input class="form-control" id="title" placeholder="{{ \'appointment.DisplayName\' | translate }}" ng-model="newAppointment.title"></div><tabset justified="true"><tab ng-repeat="resource in resources" heading="{{resource.displayName}}" ng-click="updateResource(resource)"><table id="{{resource.id}}" data-toggle="table" data-height="400" data-classes="table table-ultracondensed" bootstraptable><thead><tr><th>Hour</th><th ng-repeat=" day in days.slice(0,fwdays) ">{{ [\'Sun\', \'Mon\', \'Tue\', \'Wed\', \'Thu\', \'Fri\', \'Sat\'][day] }}</th></tr></thead><tr id="tr_id{{$index}}" ng-repeat="time in times"><td>{{time}}</td><td id="cell_{{$index}}_{{time.replace(\':\',\'-\')}}_{{resource.id}}" ng-repeat=" day in days.slice(0,fwdays) " day="{{$index}}" time="{{time}}" resource="{{resource.id}}" is-busy>&nbsp;</td></tr></table></tab></tabset><button type="submit" class="btn btn-default" ng-click="createAppointment()" ng-disabled="form.$invalid">{{ \'common.Create\' | translate }}</button></form></div><div class="col-md-6"><div class="form-group"><label for="dateAndTime">{{ \'appointment.DateTime\' | translate }}</label><div class="dropdown"><a class="dropdown-toggle" id="dropdown2" role="button" data-toggle="dropdown" data-target="#"><div class="input-group"><p class="form-control-static">{{ newAppointment.dateAndTime | date:\'d MMM, y H:mm\' }}</p></div></a><ul class="dropdown-menu" role="menu" aria-labelledby="dLabel"><datetimepicker ng-model="newAppointment.dateAndTime" data-before-render="beforeRender($view, $dates, $leftDate, $upDate, $rightDate)" datetimepicker-config="{ dropdownSelector: \'#dropdown2\', startView: \'hour\', minuteStep: {{granularity}} }"></ul></div></div><div class="form-group"><label for="duration">{{ \'appointment.Duration\' | translate }}</label><select class="form-control" id="duration" ng-model="newAppointment.duration"><option value="15">15 {{ \'appointment.Minutes\' | translate }}</option><option value="30">30 {{ \'appointment.Minutes\' | translate }}</option><option value="45">45 {{ \'appointment.Minutes\' | translate }}</option><option value="60">60 {{ \'appointment.Minutes\' | translate }}</option><option value="75">75 {{ \'appointment.Minutes\' | translate }}</option><option value="90">90 {{ \'appointment.Minutes\' | translate }}</option></select></div><div class="form-group"><label for="resource">{{ \'appointment.Resource\' | translate }}</label><select class="form-control" id="resource" ng-model="newAppointment.resource" ng-options="resource as resource.displayName for resource in resources"><option value="">{{ \'appointment.PickResource\' | translate }}</option></select></div><div class="form-group"><label for="client">{{ \'appointment.Client\' | translate }}</label><div class="input-group"><select class="form-control" id="client" ng-model="newAppointment.client" ng-options="client as client.displayName for client in clients"><option value="">{{ \'appointment.PickClient\' | translate }}</option></select><span class="input-group-btn"><button class="btn btn-default" data-toggle="collapse" data-target="#addClientPanel"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button></span></div><div class="form-group"><div id="addClientPanel" class="panel panel-default collapse"><div class="panel-body"><div class="form-group"><label for="displayName">{{ \'client.DisplayName\' | translate }}</label><input class="form-control" id="displayName" placeholder="{{ \'client.DisplayName\' | translate }}" ng-model="newAppointment.client.displayName"></div><div class="form-group"><label for="phone">{{ \'client.Phone\' | translate }}</label><input class="form-control" id="phone" placeholder="{{ \'client.Phone\' | translate }}" ng-model="newAppointment.client.phone"></div><div class="form-group"><label for="email">{{ \'client.Email\' | translate }}</label><input class="form-control" id="email" placeholder="{{ \'client.Email\' | translate }}" ng-model="newAppointment.client.email"></div></div></div></div><div class="form-group"><div class="checkbox" ng-repeat="activity in activities"><label><input type="checkbox" checklist-model="newAppointment.remarks" checklist-value="activity"> {{activity.displayName}} {{activity.duration}}</label></div></div></div></div><div class="col-md-6"><h2>{{ \'appointment.Appointments\' | translate }}</h2><p ng-if="appointments.length === 0">-- {{ \'common.None\' | translate }} --</p><ul class="list-group"><li class="list-group-item" ng-repeat="appointment in appointments"><div><div class="dropdown"><a href="" class="pull-right" ng-click="removeAppointment(appointment)" title="{{ \'common.Remove\' | translate }}"><span class="glyphicon glyphicon-remove"></span></a> <a class="dropdown-toggle" role="button" data-toggle="dropdown" data-target="#" title="{{ \'appointment.Reschedule\' | translate }}" id="appointment{{$index}}" href="" ng-click="setAppointmentForEdit(appointment)"><span class="glyphicon glyphicon-time"></span></a><ul class="dropdown-menu" role="menu"><datetimepicker data-ng-model="editAppointment.dateAndTime" data-datetimepicker-config="{ dropdownSelector: \'#appointment{{$index}}\', startView: \'hour\', minuteStep: {{granularity}} }" on-set-time="reschedule(newDate, oldDate)"></ul></div></div><h4 class="list-group-item-heading"><small style="color:orange">{{appointment.status}}</small> {{appointment.client.displayName}}<small>/{{appointment.resource.displayName}}</small> {{appointment.title}} <small>{{appointment.dateAndTime | date:\'d MMM, y H:mm\'}}-{{appointment.endDateAndTime | date:\'H:mm\'}}, duration {{appointment.duration}} mins</small></h4><p class="list-group-item-text" ng-repeat="activity in appointment.remarks">{{activity.displayName}}</p></li></ul></div></div>');
    }
  ]);
}());
(function (module) {
...
(function (module) {
  ...
  module.run([
    '$templateCache',
    function ($templateCache) {
      $templateCache.put('home/home.html', '<p translate="{{ \'home.home\' | translate }}"></p><footer class="pull-right">{{ \'home.appName\' | translate }} version {{version}} - &copy; Bogdan-Ioan BRUDIU 2015</footer>');
    }
  ]);
}());
(function (module) {
...
(function (module) {
  ...
  module.run([
    '$templateCache',
    function ($templateCache) {
      $templateCache.put('publicappointments/publicappointments.html', '<div class="row"><div class="col-md-6"><h2>{{ \'appointment.CreateNew\' | translate }}</h2><form role="form" name="form"><div class="form-group"><label for="title">{{ \'appointment.DisplayName\' | translate }}</label><input class="form-control" id="title" placeholder="{{ \'appointment.DisplayName\' | translate }}" ng-model="newAppointment.title"></div><div class="form-group"><label for="displayName">{{ \'client.DisplayName\' | translate }}</label><input class="form-control" id="email" placeholder="{{ \'client.DisplayName\' | translate }}" ng-model="newAppointment.client.displayName"></div><div class="form-group"><label for="email">{{ \'client.Email\' | translate }}</label><input class="form-control" id="email" placeholder="{{ \'client.Email\' | translate }}" ng-model="newAppointment.client.email"></div><div class="form-group"><label for="phone">{{ \'client.Phone\' | translate }}</label><input class="form-control" id="phone" placeholder="{{ \'client.Phone\' | translate }}" ng-model="newAppointment.client.phone"></div><tabset justified="true"><tab ng-repeat="resource in resources" heading="{{resource.displayName}}" ng-click="updateResource(resource)"><table id="{{resource.id}}" data-toggle="table" data-height="400" data-classes="table table-ultracondensed" bootstraptable><thead><tr><th>Hour</th><th ng-repeat=" day in days.slice(0,fwdays) ">{{ [\'Sun\', \'Mon\', \'Tue\', \'Wed\', \'Thu\', \'Fri\', \'Sat\'][day] }}</th></tr></thead><tr id="tr_id{{$index}}" ng-repeat="time in times"><td>{{time}}</td><td id="cell_{{$index}}_{{time.replace(\':\',\'-\')}}_{{resource.id}}" ng-repeat=" day in days.slice(0,fwdays) " day="{{$index}}" time="{{time}}" resource="{{resource.id}}" is-busy>&nbsp;</td></tr></table></tab></tabset><button type="submit" class="btn btn-default" ng-click="createAppointment()" ng-disabled="form.$invalid">{{ \'common.Create\' | translate }}</button></form></div><div class="col-md-6"><div class="form-group"><label for="dateAndTime">{{ \'appointment.DateTime\' | translate }}</label><div class="dropdown"><a class="dropdown-toggle" id="dropdown2" role="button" data-toggle="dropdown" data-target="#"><div class="input-group"><p class="form-control-static">{{ newAppointment.dateAndTime | date:\'d MMM, y H:mm\' }}</p></div></a><ul class="dropdown-menu" role="menu" aria-labelledby="dLabel"><datetimepicker ng-model="newAppointment.dateAndTime" data-before-render="beforeRender($view, $dates, $leftDate, $upDate, $rightDate)" datetimepicker-config="{ dropdownSelector: \'#dropdown2\', startView: \'hour\', minuteStep: {{granularity}} }"></ul></div></div><div class="form-group"><div class="checkbox" ng-repeat="activity in activities"><label><input type="checkbox" checklist-model="newAppointment.remarks" checklist-value="activity"> {{activity.displayName}} {{activity.duration}}</label></div></div></div></div>');
    }
  ]);
}());
(function (module) {
  ...
  module.run([
    '$templateCache',
    function ($templateCache) {
      $templateCache.put('public/public.html', '<p translate="{{ \'home.Public\' | translate }}"></p><p>&lt;iframe src="#/publicappointments/{{user.userId}}"/&gt;</p>');
    }
  ]);
}());
(function (module) {
...
angular.module('makemybooking.activities', [
  ...
  'flash',
  'moment',
  function ActivitiesController($scope, $window, _, $translate, makemybookingapi, flash, moment) {
    function load() {
      return makemybookingapi.apiRoot.then(function (rootActivity) {
        return rootActivity.$get('activities').then(function (activitiesActivity) {
          return activitiesActivity.$get('activities').then(function (activities) {
...
angular.module('makemybooking.appointments', [
  ...
  'flash',
  'moment',
  function AppointmentsController($scope, $window, _, $translate, makemybookingapi, flash, moment) {
    function load() {
      ...
      makemybookingapi.apiRoot.then(function (rootResource) {
        return rootResource.$get('resources').then(function (resourcesResource) {
          return resourcesResource.$get('resources').then(function (resources) {
      ...
      makemybookingapi.apiRoot.then(function (rootResource) {
        return rootResource.$get('clients').then(function (clientsResource) {
          return clientsResource.$get('clients').then(function (clients) {
            // get embedded appointments
          ...
          return appointmentsResource.$get('appointments').then(function (appointments) {
            appointments.forEach(function (appointment) {
              $dates.forEach(function (date) {
                if (appointments.filter(function (element) {
                    if (date.dateValue + new Date().getTimezoneOffset() * 60 * 1000 >= Date.parse(element.dateAndTime) && date.dateValue + new Date().getTimezoneOffset() * 60 * 1000 < Date.parse(element.endDateAndTime)) {
                      return element;
                    }
                  }).length > 0) {
...
angular.module('makemybooking.appointmentsView', [
  ...
  'flash',
  'moment',
  function AppointmentsViewController($scope, $window, _, $translate, $filter, $compile, makemybookingapi, flash, moment) {
    $scope.fwdays = 3;
    $scope.whours = 10;
    ...
    function load() {
      ...
      makemybookingapi.apiRoot.then(function (rootResource) {
        return rootResource.$get('activities').then(function (activitiesResource) {
          return activitiesResource.$get('activities').then(function (activities) {
            // get embedded appointments
    ...
    $scope.$watch(function (scope) {
      return scope.newAppointment.dateAndTime;
    }, function () {
      $scope.refreshCandidate();
    });
    $scope.$watch(function (scope) {
      return scope.newAppointment.duration;
    }, function () {
      $scope.refreshCandidate();
    });
    $scope.$watchCollection(function (scope) {
      return scope.newAppointment.remarks;
    }, function () {
          ...
          $dates.forEach(function (date) {
            if ($view == 'hour') {
              ...
              for (i = 0; i < 60; i = i + $scope.granularity) {
                if (appointments.filter(function (element) {
                    if (date.dateValue + new Date().getTimezoneOffset() * 60 * 1000 + i * 60 * 1000 >= Date.parse(element.dateAndTime) && date.dateValue + new Date().getTimezoneOffset() * 60 * 1000 + i * 60 * 1000 < Date.parse(element.endDateAndTime)) {
                      return element;
                    }
                  }).length > 0) {
                  count++;
  ...
  function (timer) {
    ...
    return {
      link: function (scope, elem, attrs, ctrl) {
        ...
        // hello();
        timer(bootstrapTable, 0);  // It works even with a delay of 0s
      }
    };
  }
]);
angular.module('makemybooking.usersession', [
  ...
  'makemybookingapi',
  '_',
  function ($rootScope, $window, config, flash, makemybookingapi, _) {
    var defaultSession = {
        userId: '',
        displayName: '',
  ...
  'makemybookingapi',
  'usersession',
  function ($window, $rootScope, $log, makemybookingapi, usersession) {
...
angular.module('makemybooking.clients', [
  ...
  'flash',
  'moment',
  function ClientsController($scope, $window, _, $translate, makemybookingapi, flash, moment) {
    function load() {
      return makemybookingapi.apiRoot.then(function (rootClient) {
        return rootClient.$get('clients').then(function (clientsClient) {
          return clientsClient.$get('clients').then(function (clients) {
            // get embedded clients
            $scope.clients = clients;
          });
        }, function (err) {
          flash.addError(err.data);
...
angular.module('makemybooking.public', [
  ...
  'flash',
  'makemybookingapi',
  function PublicController($scope, flash, makemybookingapi) {
    makemybookingapi.apiRoot.then(function (rootResource) {
      return rootResource.$get('me').then(function (userResource) {
...
angular.module('makemybooking.publicappointments', [
  ...
  '$routeProvider',
  function config($routeProvider) {
    $routeProvider.when('/publicappointments/:userId', {
  ...
  'flash',
  'moment',
  function AppointmentsViewController($scope, $window, _, $translate, makemybookingapi, flash, moment) {
    $scope.fwdays = 7;
    $scope.whours = 10;
    $scope.granularity = 10;
    $scope.celsMerge = 3;
    ...
    $scope.createAppointment = function () {
      return makemybookingapi.apiRoot.then(function (rootResource) {
        // Sync endDateAndTime first
        $scope.newAppointment.endDateAndTime = moment($scope.newAppointment.dateAndTime).add($scope.newAppointment.duration, 'minutes');
        return rootResource.$post('publicappointments', {
          'userId': $scope.$parent.currentRoute.params.userId,
          'email': $scope.newAppointment.client.email
        }, $scope.newAppointment).then(function () {
          flash.add($translate.instant('appointment.Created'), 'info');
          initAppointment();
        }, function (err) {
          flash.addError(err.data);
...
angular.module('makemybooking.resources', [
  ...
  'makemybookingapi',
  'flash',
  function ResourcesController($scope, $window, _, $translate, makemybookingapi, flash) {
    function load() {
      return makemybookingapi.apiRoot.then(function (rootResource) {
        return rootResource.$get('resources').then(function (resourcesResource) {
          return resourcesResource.$get('resources').then(function (resources) {
...
angular.module('makemybooking.myaccount', [
  ...
  'makemybookingapi',
  'flash',
  function UsersController($scope, $window, _, $translate, makemybookingapi, flash) {
    function load() {
      return makemybookingapi.apiRoot.then(function (rootUser) {
        return rootUser.$get('me').then(function (userResource) {
          return userResource.$get('self').then(function (myUser) {
            // get embedded resources
    ...
    function load() {
      return makemybookingapi.apiRoot.then(function (rootUser) {
        return rootUser.$get('users').then(function (usersUser) {
          return usersUser.$get('users').then(function (users) {
            // get embedded users
            $scope.users = users;
          });
        }, function (err) {
...
angular.module('makemybooking.authinterceptor', ['makemybooking.usersession']).factory('authInterceptor', [
  '$rootScope',
  '$q',
  '$window',
  '$location',
...
angular.module('makemybooking.login', [
  ...
  function ($window, $rootScope, $location, config, usersession) {
    $rootScope.authLogin = function authLogin(token) {
      usersession.login(token).then(function () {
  ...
  'usersession',
  'makemybookingapi',
  function LoginController($scope, $rootScope, $window, $location, config, usersession, makemybookingapi) {
    ...
    $scope.loginLocal = function (user) {
      makemybookingapi.apiRoot.then(function (rootResource) {
        return rootResource.$get('localauth', {
          ...
          $rootScope.authLogin(authData.token);
        });
      });
    };
...
angular.module('makemybooking', [
  ...
  'tmhDynamicLocale',
  'usersession',
  function AppController($scope, $rootScope, $location, $translate, tmhDynamicLocale, usersession) {

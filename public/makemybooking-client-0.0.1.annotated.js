...
angular.module('appoints.appointments', [
  ...
  'flash',
  'moment',
  function AppointmentsController($scope, $window, _, $translate, appointsapi, flash, moment) {
    function load() {
...
angular.module('appoints.usersession', [
  ...
  'appointsapi',
  '_',
  function ($rootScope, $window, config, flash, appointsapi, _) {
    var defaultSession = {
        userId: '',
        displayName: '',
...
angular.module('appoints.clients', [
  ...
  'flash',
  'moment',
  function ClientsController($scope, $window, _, $translate, appointsapi, flash, moment) {
    function load() {
...
angular.module('appoints.resources', [
  ...
  'appointsapi',
  'flash',
  function ResourcesController($scope, $window, _, $translate, appointsapi, flash) {
    function load() {
      return appointsapi.apiRoot.then(function (rootResource) {
        return rootResource.$get('resources').then(function (resourcesResource) {
          return resourcesResource.$get('resources').then(function (resources) {
...
angular.module('appoints.users', [
  ...
  'appointsapi',
  'flash',
  function UsersController($scope, $window, _, $translate, appointsapi, flash) {
    function load() {
...
angular.module('appoints.login', [
  ...
  'usersession',
  'appointsapi',
  function LoginController($scope, $rootScope, $window, $location, config, usersession, appointsapi) {
